    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "config_name",
                    models.CharField(max_length=100, verbose_name="查寝配置名称"),
                ),
                ...
                (
                    "late_end",
                    models.TimeField(
                        blank=True, null=True, verbose_name="晚归截止时间"
                    ),
                ),
                (
                    "valid_range",
                    models.IntegerField(default=500, verbose_name="打卡有效范围（米）"),
                ),
                (
                    "need_material",
                    models.BooleanField(
                        default=False, verbose_name="是否需要上传证明材料"
                    ),
                ),
                (
                    "notify_normal_after_normal_end",
                    models.BooleanField(
                        default=True, verbose_name="正常结束后是否通知"
                    ),
                ),
                (
                    "notify_late_after_late_end",
                    models.BooleanField(
                        default=False, verbose_name="晚归结束后是否通知"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "late_reason",
                    models.TextField(blank=True, null=True, verbose_name="晚归理由"),
                ),
                (
                    "material",
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to="attendance_materials/",
                        verbose_name="证明材料",
                    ),
                ),
